...
export const termGroups = [
...

  {
    ...
    terms: [
      ...
      { id: 'pp', term: 'PP', full: 'Push Press', ko: '푸시 프레스', desc: '딥-드라이브로 띄우고 팔로 마무리하는 오버헤드 동작. 밀다가 무릎을 다시 굽히면 푸시 저크다. 덤벨로 하면 덤벨 푸시 프레스.', movement: 'push-press' },
      { id: 'sp', term: 'SP', full: 'Shoulder Press / Strict Press', ko: '숄더 프레스', desc: '다리 반동 없이 팔과 어깨만으로 바를 머리 위로 미는 프레스. 스트릭트 프레스라고도 한다.', movement: 'shoulder-press' },
