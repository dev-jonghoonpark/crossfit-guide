...
RNL CrossFit 화이트보드 11장에서 뽑았다.

| 분류 | 동작 |
|---|---|
| 역도 | 스쿼트 클린 · 행 스쿼트 클린 · 행 파워 클린 · 스플릿 저크 · 푸시 저크 · 숄더 프레스 · 푸시 프레스 · 클린 앤 저크 · 데드리프트 · SDHP · 벤치 프레스 · 펜들레이 로우 · 파워 스내치 · 행 파워 스내치 · 스쿼트 스내치 |
...
와드 10장은 `wods.html` 에서 형식·태그별로 필터링해 볼 수 있다.
