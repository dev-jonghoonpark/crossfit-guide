...
export const wods = [
  /* ==================================================================== */
  {
      ...
      },
      {
        ...
        lines: [
          ...
          },
          {
            ...
            read: '풀업 21회',
            explain:
              '와드의 첫 줄이라 몸이 제일 싱싱할 때다. 그래서 21회를 한 번에 가고 싶어지는데, ' +
              '바로 뒤에 오버헤드 스쿼트 42회가 붙어 있다. 여기서 그립과 어깨를 다 쓰면 그 42회가 통째로 무너진다 — ' +
              '11+10 정도로 미리 끊어 두고, 대신 봉에서 내려와 있는 시간을 짧게 가져간다.',
            movement: 'pull-up',
          },
          {
          ...
          },
          {
            ...
            explain:
              ...
              '총량은 풀업 45 · 오버헤드 스쿼트 90 으로 135렙인데, 그중 90렙이 바벨이라 시간은 대부분 오버헤드 스쿼트에서 나간다. ' +
              '넉넉한 캡이 아니다 — 바를 한 번 놓칠 때마다 다시 머리 위로 올리는 데만 10초 넘게 새어 나간다.',
            term: 'time-cap',
          },
        ],
        summary:
    ...
    record:
      ...
      '파트 2 — 완료 시간. 12분 캡에 걸리면 "12:00 CAP + 완료한 렙 수"로 적고, 사용한 스케일(a·b)을 같이 적는다. ' +
      '히어로 와드라 다음에 또 만난다 — 오버헤드 스쿼트에 쓴 무게를 꼭 남겨 두자.',
  },
