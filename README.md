...
RNL CrossFit 화이트보드 7장에서 뽑았다.

| 분류 | 동작 |
|---|---|
| 역도 | 스쿼트 클린 · 행 스쿼트 클린 · 스플릿 저크 · 푸시 저크 · 클린 앤 저크 · 데드리프트 · SDHP · 벤치 프레스 · 파워 스내치 · 행 파워 스내치 · 스쿼트 스내치 |
| 체조 | 풀업 · 체스트 투 바 · 토투바 · 링 딥 · HSPU · 푸시업 · 디피싯 푸시업 · 에어 스쿼트 · 피스톨 스쿼트 |
| 덤벨 | 덤벨 스내치 · 덤벨 데드리프트 · 덤벨 행 파워 클린 · 덤벨 S2OH |
| 기타 기구 | 월볼 · 박스 점프 |
| 모노스트럭처 | 더블 언더 · 로잉 |

와드 7장은 `wods.html` 에서 형식·태그별로 필터링해 볼 수 있다.
